local({
  ...
  if (markdown == 'kramdown') {
    knitr::render_jekyll(highlight = "pygments", extra = "lineanchors linenos=table")
  ...
  if (Sys.getenv('USER') == 'charles') {
    ...
    knitr::opts_knit$set(
      ...
      base.url = 'https://dl.dropboxusercontent.com/u/6337901/jekyll/'
    )
  }
